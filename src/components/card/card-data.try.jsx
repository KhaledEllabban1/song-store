...
// const CardData = ({singer, addSinger, removeSinger, selectedSingers, checkedValue, handleChange}) => {
...
//     //   // existingItem ?  setChecked(checked) : setChecked(!checked);;
//     // };
//     // console.log(checked);
//     // const singersNames = selectedSingers.map(selectedSinger => selectedSinger.id === singer.id ? (<p> {singer.name} </p>) : 'null'  );
    
//     // const existingItem = selectedSingers.find (
//     //   selectedSingersArrEl => selectedSingersArrEl.id === singer.id
//     // )
...
//                         <Checkbox
//                             checked={checkedValue ? () => addSinger(singer) : () => removeSinger(singer)}
...
//     // handleChange : checkedValue => dispatch(toggle(checkedValue))
// });
